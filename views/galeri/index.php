       ...
       <div class="d-grid d-md-flex align-items-center justify-content-between gap-2 mt-3 pt-3">{summary}{pager}</div>',
            ...
            'columns' => [
                ...
                [
                    ...
                    'attribute' => 'fileGambar',
                    'format' => 'raw',
                    'value' => function ($model) {
                        return Html::img(Yii::$app->request->baseUrl . '/img/galeri/' . $model->gambar, ['width' => '50%']);
                    },
                ],
                [
                        ...
                        'button' => function ($url, $model, $key) {
                            $links = [
                                ...
                                [
                                    ...
                                    'url' => Url::toRoute(['hapus-gambar', 'id' => $model->id]),
